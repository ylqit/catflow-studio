...
2026-09-08 增量交接：外部任务的执行契约、原始回执、恢复调度、租约、未知任务后续生成及统一页面，见 [外部任务状态与恢复](JOB_EXECUTION_RECOVERY.md)。这部分以迁移 `0031_job_execution_recovery` 和该文档为准；下文较早的任务描述不能替代新的恢复规则。
